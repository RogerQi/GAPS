...
class _SimpleSegmentationModel(backbone_base):
    def __init__(self, cfg, backbone, classifier, bn_freeze):
        super(_SimpleSegmentationModel, self).__init__(cfg)
...
# =========================================================
# SSUL/network/backbone/resnet.py
# =========================================================
...
# =========================================================
# SSUL/network/modeling.py
# =========================================================

def _segm_resnet(cfg, name, backbone_fn, output_stride, pretrained_backbone, bn_freeze):
    ...
    model = DeepLabV3(cfg, backbone, classifier, bn_freeze)
    return model
...
def deeplabv3_resnet101(cfg):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    return _segm_resnet(cfg, 'deeplabv3', resnet101, output_stride=16, 
                       pretrained_backbone=False, bn_freeze=False)
